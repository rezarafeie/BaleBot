...
<body class="bg-[#f8fafc] flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-xl border border-[#e2e8f0] w-full max-w-sm">
        ...
        <form method="POST" action="login.php">
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg focus:outline-none transition-colors mb-4">
                ورود
            </button>
            <div class="text-center">
                <span class="text-xs text-slate-400">حساب کاربری ندارید؟</span>
                <a href="../register.php" class="text-xs text-blue-600 font-bold hover:underline">ثبت‌نام کنید</a>
            </div>
        </form>
    </div>
</body>
